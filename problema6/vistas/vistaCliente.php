            ...
            <table class="table table-sm table-hover">
                ...
                <tbody>
                    <?php
                        ...
                        echo "<a class='btn btn-success m-1' href='../formularios/formañadircuenta.php?id_persona=$id_persona'>Añadir</a>";
                            ...
                            echo "  <a class='btn btn-danger m-1' data-bs-toggle='modal' data-bs-target='#exampleModal'>Eliminar todo</a>
                                    ...
                                    <div class='modal-dialog'>
                                        ...
                                        <div class='modal-footer'>
                                            ...
                                            <a class='btn btn-dark' href='../controladores/eliminarcuenta.php?id_cuenta_bancaria=$registro[id_cuenta_bancaria]'>Eliminar</a>
                                        </div>
                                        </div>
